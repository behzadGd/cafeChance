    ...
    <div className='w-full h-screen flex'>
      <div className="bg-[url('../public/img/3.jpg')] bg-cover w-full h-full flex justify-end items-end ">
                ...
                <div className='w-1/2 h-96 flex-col content-end item-end'>
                  ...
                  <h1 className='font-extrabold text-8xl text-black text-right  mb-5'>کافه چنس</h1>
                  <h2 className='text-xl text-black font-bold text-right mr-16 mt-3'>شانستو برای مزه بهتر امتحان کن</h2>
                </div>
               
               
                <div className='mb-32  w-2/5 '>
                  <Button className='btn btn-outline mx-3 bg-stone-800 mt-9 '>رزرو آنلاین</Button>
